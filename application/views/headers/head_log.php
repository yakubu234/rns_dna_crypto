...
if ($this->session->userdata('email') == '' ) {
  redirect(base_url().'RNS_system/logout');
}else{
...
<div class="col-auto ml-auto">
    <div class="tt-account-btn">
        ...
        <a href="<?php echo base_url('DBoard');?>" class="btn btn-primary">Dashboard</a>
        <a href="<?php echo base_url('Out');?>" class="btn btn-primary">Log out</a>
         <a href="<?php echo base_url('D');?>" class="tt-btn-create-topic">
            <span class="tt-icon">
                <svg>
