        ...
        <div class="tt-categories-list">
           <div id="modal">
                    ...
                    <div class="modalconent">
                       ...
                       <form class="form-default" method="POST" action="<?php echo base_url('auth') ?>">
                        ...
                        <?php 
                           ...
                           <label style="text-align: center;color: red;">Enter Decryption Key</label>
                           <input type="text" name="decryption" required="" class="form-control"><p></p>
                           <input type="submit" name="submit" class="btn btn-secondary btn-block" value="Authenticate">
                       </form>
                    ...
                    <div class="tt-item">
                        <div class="tt-item-header">
                            <ul class="tt-list-badge">
                                <li><a href="#"><span class="tt-color01 tt-badge">DNA Cryptography</span></a></li>
                            </ul>
                            <h6 class="tt-title"><a href="page-categories-single.html"><?php echo $date; ?></a></h6>
                        </div>
                        <div class="tt-item-layout">
                           <div class="innerwrapper">
                            <p>Please input decryption key to be able to view this file  </p>
                            <i class="fa fa-folder-open-o" aria-hidden="true" style="font-size: 30px;"></i>
                               <a href="#"  style="word-wrap: break-word;"><?php echo $message; ?> </a>
                           </div>
