    ...
    <div class="tt-custom-mobile-indent container">
        ...
        <div class="tt-categories-list">
            <div class="row">
                ...
                foreach ($query->result() as $row) {
                    ...
                    <div class="tt-item">
                        <div class="tt-item-header">
                            ...
                            <h6 class="tt-title"><a href="page-categories-single.html"><?php echo $row->date; ?></a></h6>
                        </div>
                        <div class="tt-item-layout">
                           <div class="innerwrapper">
                            <p>Here is the record you have sent so far  </p>
                            <i class="fa fa-folder-open-o" aria-hidden="true" style="font-size: 30px;"></i>
                               <a href="<?php echo base_url('uploads/'.$row->message); ?>" download  style="word-wrap: break-word;"><?php echo $row->message; ?> </a>
                           </div>
                ...
                $val = 'you have 0 files in your file manager' ;
