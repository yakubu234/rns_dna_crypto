...
// }
$email = $this->session->userdata('email') ;
$decryption = $this->session->userdata('decryption') ;
...
<main id="tt-pageContent">
    <div class="tt-custom-mobile-indent container">
        <div class="tt-categories-title">
            ...
            <div class="tt-search">
                <i class="fa fa-user" >&nbsp;&nbsp;&nbsp; <?php echo $user; ?></i>
            </div>
        </div>
                    ...
                    <div class="tt-item">
                        ...
                        <div class="tt-item-layout">
                           <div class="innerwrapper">
                            <p>Here is the record you can now download it </p>
                            <i class="fa fa-folder-open-o" aria-hidden="true" style="font-size: 30px;"></i>
                               <a href="<?php echo base_url('uploads/'.$decryption); ?>" download><?php echo $decryption; ?> </a>
                           </div>
