    ...
    <div class="container">
        <div class="tt-wrapper-inner">
           <div class="tt-categories-title">
            <div class="tt-title">Send Secured Message</div>
            <div class="tt-search">
        ...
        ?>
        <h1 style="text-align:center;padding-bottom: 10px;"><u>Fill the field</u></h1>
        <input type="hidden" name="email"  value="<?php echo $email; ?>" >
        <div>
            <label for="fileselect">Upload File:</label>
            <input type="file" name="file" placeholder="Enter Invite Subject" >
        </div>
        ...
        <div>
            ...
            <input type="email" name="user_email" placeholder="Enter Invitee email" >
        </div>
        &nbsp;<br>
        <div id="submitbutton">
