	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 col-sm-6">
				<ul class="breadcrumb">
					<li><a href="index.php">home</a></li	<li><i class="fa fa-chevron-left"></i></li>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						<div class="ed_item_img">
							<img src="http://placehold.it/408X227" alt="item1" class="img-responsive">
						</div>
						<div class="ed_item_description ed_most_recomended_data">
							<h4><a href="course_single.phproject Learning </a><span>£25</span></h4>
							<div class="row">
								<div class="ed_rating">
							...
							<div class="course_detail">
								<div class="course_faculty">
									<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.phh">Joanna Simpson</a>
								</div>
							</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						...
						<div class="ed_item_description ed_most_recomended_data">
								...
								<p>In a lot of various jobs, psychology tests are something you will have to deal with find Pretty. We can prepare you.</p>
								<a href="course_single.php" class="ed_getinvolved">get involved <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
