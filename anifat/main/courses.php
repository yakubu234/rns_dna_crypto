				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					...
					<div class="edoco_menu">
						<ul class="collapse navbar-collapse" id="ed_menu">
							...
							<li><a href="#">blog</a>
								<ul class="sub-menu">
									<li><a href="blog.php">blog-large</a></li>
									<li><a href="blog_med.php">blog-medium</a></li>
							...
							<li><a href="#">events</a>
								<ul class="sub-menu">
									...
									<li><a href="event_single.php">events-single</a></li>
								</ul>
							</li>
							<li><a href="#">courses</a>
								<ul class="sub-menu">
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 col-sm-6">
				<ul class="breadcrumb">
					...
					<li><a href="course.php">Educo Courses</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
					...
					<div class="ed_item_description ed_most_recomended_data">
						...
						<div class="course_detail">
							<div class="course_faculty">
								<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">Joanna Simpson</a>
							</div>
						</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="ed_mostrecomeded_course">
					...
					<div class="ed_item_description ed_most_recomended_data">
						...
						<div class="course_detail">
							<div class="course_faculty">
								<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">DESPERATE SCOTT</a>
							</div>
						</div>
						<p>Project-Based Learning is a flexible tool for framing given academic standards into curriculum flexible tool for framing.</p>
						<a href="course_single.php" class="ed_getinvolved">get involved <i class="fa fa-long-arrow-right"></i></a>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="ed_mostrecomeded_course">
					...
					<div class="ed_item_description ed_most_recomended_data">
							...
							<div class="course_detail">
								<div class="course_faculty">
									<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">MIKE TUSSLE</a>
								</div>
							</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="ed_mostrecomeded_course">
					...
					<div class="ed_item_description ed_most_recomended_data">
							...
							<div class="course_detail">
								<div class="course_faculty">
									<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">James Marco</a>
								</div>
							</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="ed_mostrecomeded_course">
					...
					<div class="ed_item_description ed_most_recomended_data">
							...
							<div class="course_detail">
								<div class="course_faculty">
									<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">Andre House</a>
								</div>
							</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="ed_mostrecomeded_course">
					...
					<div class="ed_item_description ed_most_recomended_data">
							<h4><a href="course_single.php">management prog. </a><span>£43</span></h4>
							<div class="row">
								<div class="ed_rating">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<div class="row">
							...
							<div class="course_detail">
								<div class="course_faculty">
									<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">Tina Fibonacci</a>
								</div>
							</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="ed_mostrecomeded_course">
					...
					<div class="ed_item_description ed_most_recomended_data">
							<h4><a href="course_single.php">Model Specificity </a><span>£23</span></h4>
							<div class="row">
								<div class="ed_rating">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<div class="row">
							...
							<div class="course_detail">
								<div class="course_faculty">
									<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">Shy Tommy</a>
								</div>
							</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="ed_mostrecomeded_course">
					...
					<div class="ed_item_description ed_most_recomended_data">
							<h4><a href="course_single.php">mobile capabilities </a><span>£45</span></h4>
							<div class="row">
								<div class="ed_rating">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<div class="row">
							...
							<div class="course_detail">
								<div class="course_faculty">
									<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.php">Scott Again</a>
								</div>
							</div>
...
<div class="ed_newsletter_section" data-stellar-background-ratio="0" data-stellar-vertical-offset="-500">
<div class="ed_img_overlay"></div>
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
