		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 col-sm-6">
				<ul class="breadcrumb">
					...
					<li><a href="course.php">single course</a></li>
					<li><i class="fa fa-chevron-left"></i></li>
					<li><a href="purchase_course.php">Purchase Course</a></li>
				</ul>
			</div>
				...
				<div class="row">
					<div class="col-lg-5 col-md-5 col-sm-12">
						<div class="ed_course_single_image">
							<img src="http://placehold.it/317X152" alt="event image" />
						</div>
					</div>
					<div class="col-lg-7 col-md-7 col-sm-12">
						<div class="ed_course_single_info">
							...
							<a href="#" class="btn ed_btn ed_green">add to cart</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="ed_mostrecomeded_course_slider ed_toppadder40 ed_bottompadder40">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="ed_item_img">
								<img src="http://placehold.it/249X157" alt="item1" class="img-responsive">
							</div>
							<div class="ed_item_description ed_most_recomended_data">
									...
									<a href="#" class="btn ed_btn ed_orange btn-sm">add to cart</a>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="ed_item_img">
					...
					<aside class="widget widget_cart">
						<div class="course_single_item">
							<div class="course_single_info">
								...
								<img src="http://placehold.it/80X38" alt="event image" /><a href="#" data-toggle="tooltip" data-placement="bottom" title="Remove Item">x</a>
								<h5>Project Learning</h5>
								<p class="quantity">1 X <span>£25</span></p>
								</div>
								<div class="purchase_title">
								<img src="http://placehold.it/80X38" alt="event image" /><a href="#" data-toggle="tooltip" data-placement="bottom" title="Remove Item">x</a>
								<h5>user experience jam</h5>
								<p class="quantity">1 X <span>£38</span></p>
								</div>
								<p class="total">Subtotal: <span>£63</span></p>
