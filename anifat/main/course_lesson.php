		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 col-sm-6">
				<ul class="breadcrumb">
					...
					<li><a href="courses.phph">educo courses</a></li>
					<li><i class="fa fa-chevron-left"></i></li>
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
			...
			<div class="ed_time_executor ed_toppadder40">
				<ul>
					...
					<li><a href="course_lesson.php">development overview</a> <span><i class="fa fa-check-circle-o"></i></span></li>
					<li><a href="course_lesson.php">basic html</a> <span>Currently active</span></li>
					<li><a href="course_lesson.php">Basic CSS</a> <span>Locked</span></li>
					<li><a href="course_lesson.php">Advanced HTML + CSS</a> <span>Locked</span></li>
					<li><a href="course_lesson.php">Javascript Beginners</a> <span>Locked</span></li>
				</ul>
			</div>
			</div>
